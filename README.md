...
- Python (aiohttp, requests), PostgreSQL, Redis
- Docker, Celery, OpenAPI 3.0, SQL, BPMN

**📎 Артефакты:**
- Спецификация API (OpenAPI YAML/JSON)
- Диаграмма последовательности синхронизации товаров
- Схема данных БД для синхронизированных сущностей
