...
- [Пример пользовательского сценария](/docs/04_Use_Cases.md)

**Пример структуры требований:**
```yaml
Функциональный блок "Финансовый учет":
  - FR7: Базовые категории расходов (5 предустановленных)
  - FR8: Пользовательские категории (максимум 20)
  - FR9: Визуализация бюджета (круговая/столбчатая диаграмма)
