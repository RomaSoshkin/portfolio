...
**Проблема:** Бумажные листы отбора导致 ошибки комплектации и замедление операций.

**Решения:**
- Провёл воркшопы с warehouse-менеджерами
...
- **Анализ данных:** SQL (MS SQL Server), Python (pandas)
- **BI-системы:** Yandex DataLens, Power BI
- **Документирование:** Confluence, Jira, Draw.io
- **Интеграции:** REST API, JSON/XML, EDI
